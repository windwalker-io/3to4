...
namespace Windwalker\Legacy\Query\Test\Sqlite;

use Windwalker\Legacy\Database\Test\AbstractQueryTestCase;
use Windwalker\Legacy\Query\Sqlite\SqliteQuery;
 ...
 */
class SqliteQueryTest extends AbstractQueryTestCase
{
    use QueryTestTrait;
    ...
    {
        $this->assertEquals('sqlite', $this->instance->getName());
    }
