...
namespace Windwalker\Legacy\Database\Schema;
...
class Schema
{
    ...
    {
        $class = 'Windwalker\Legacy\Database\Schema\Column\\' . ucfirst($name);

        if (!class_exists($class)) {
            $class = 'Windwalker\Legacy\Database\Schema\Column\\' . ucfirst($name) . 'Type';
        }
