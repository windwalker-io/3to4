...
use Windwalker\Legacy\Database\Driver\Pdo\PdoDriver;
use Windwalker\Legacy\Database\Driver\Pdo\PdoReader;

/**
 * Test class of SqlsrvReader
 *
 * @since 2.0
 * @deprecated Legacy code
 */
class SqlsrvReaderTest extends AbstractSqlsrvTestCase
{
    /**
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::fetchArray
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::fetchAssoc
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::fetchObject
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::fetch
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::fetchAll
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::count
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Driver\Pdo\PdoReader::countAffected
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::setQuery
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::getIterator
     */
    public function testGetIterator()
    {
        ...
        $this->assertInstanceOf('Windwalker\Legacy\Database\Iterator\DataIterator', $iterator);
        ...
        foreach ($r1 = $this->db->getReader(
            $this->db->getQuery(true)
            ->select('*')
            ->from('#__categories')
            ->limit(3)
        ) as $cat) {
            foreach ($r2 = $this->db->getReader(
                $this->db->getQuery(true)
                    ->select('*')
                    ->from('#__flower')
                    ->where('catid = ' . $cat->id)
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadResult
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadColumn
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadArray
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadArrayList
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadAssoc
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadAssocList
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadObject
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::loadObjectList
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::freeResult
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::getDriver
     */
     ...
     * @covers \Windwalker\Legacy\Database\Command\AbstractReader::setDriver
     */
