...
class DatabaseFactoryTest extends \PHPUnit\Framework\TestCase
{
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\DatabaseFactory::getDbo
     */
    public function testGetDbo()
    {
        ...
        $this->assertInstanceOf(
            'Windwalker\Legacy\\Database\\Driver\\Mysql\\MysqlDriver',
     ...
     * @covers \Windwalker\Legacy\Database\DatabaseFactory::setDefaultDbo
     */
     ...
     * @return void
     *
     * @covers \Windwalker\Legacy\Database\DatabaseFactory::createDbo
     */
