...
namespace Windwalker\Legacy\Database\Driver\Pdo;
...
class PdoDriver extends AbstractDatabaseDriver
{
    ...
    {
        $builder = sprintf('Windwalker\Legacy\\Query\\%s\\%sGrammar', $this->name, $this->name);
        ...
        /** @var $builder \Windwalker\Legacy\Query\QueryGrammarInterface */
