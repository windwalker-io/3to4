...
namespace Windwalker\Legacy\Database;

use Windwalker\Legacy\Database\Driver\AbstractDatabaseDriver;
use Windwalker\Legacy\Database\Driver\DatabaseDriverInterface;
...
abstract class DatabaseFactory
{
    ...
    public static function createDbo($driver, array $options)
    {
        ...
        $class = '\\Windwalker\Legacy\\Database\\Driver\\' . ucfirst(strtolower($options['driver'])) . '\\'
