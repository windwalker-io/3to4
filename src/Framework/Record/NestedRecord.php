...
namespace Windwalker\Legacy\Record;

use Windwalker\Legacy\Database\Query\QueryHelper;
use Windwalker\Legacy\Record\Exception\NestedHandleException;
use Windwalker\Legacy\Record\Exception\ParentIsChildException;
use Windwalker\Legacy\Record\Exception\ParentIsSelfException;
...
class NestedRecord extends Record
{
     ...
     *
     * @return  static
     * @throws \Windwalker\Legacy\Record\Exception\WrongParentException
     */
